//! D04: minimal Customer endpoints.
//! GET  /api/v1/branches/:branch_id/customers        — list for Order create form picker
//! POST /api/v1/branches/:branch_id/customers        — inline create from picker
